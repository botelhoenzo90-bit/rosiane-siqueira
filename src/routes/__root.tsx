...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Rosiane Siqueira | Especialista em Criolipólise" },
      { name: "description", content: "Rosiane Siqueira, especialista em criolipólise e cuidados estéticos personalizados, com atendimento individualizado e acolhedor." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@300;400;500&family=Jost:wght@300;400;500&family=Parisienne&display=swap" },
